...
class SignupButtonArrow extends StatefulWidget {
  ...
  const SignupButtonArrow({Key key, this.label, this.background, this.borderColor, this.fontColor, this.onTap, this.child}) : super(key: key);

  @override
  _SignupButtonArrowState createState() => _SignupButtonArrowState();
}

class _SignupButtonArrowState extends State<SignupButtonArrow>
